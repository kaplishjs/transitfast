        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 car_detail_desc section_padding">
              ...
              <h2 className="heading_m mb-4">
                Citroen Berlingo Van M BlueHDi 100 6-speed manual 650 Enterprise
                Edition
              </h2>
              <div className="d-flex gap-2 flex-wrap mb-4">
                <button
                  type="button"
                  class="btn btn-outline-secondary rounded-pill desc_pill"
                >
                  make
                </button>
                <button
              ...
              <ul className="ps-3">
                ...
                <li>Electric Front Windows with One Touch Operation</li>
              </ul>
              <div className="d-flex align-items-end justify-content-end">
                <h5 className="mb-0 headieding_s fc_primary2 ">Price:</h5>{" "}
                <h4 className="headieding_l mb-0">£6,500</h4>
              </div>
            </div>
          </div>
        </div>
